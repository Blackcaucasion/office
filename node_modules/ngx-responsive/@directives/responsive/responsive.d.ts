...
export declare class ResponsiveDirective implements OnDestroy {
    ...
    private cd;
    private _config;
    set responsive(config: string | string[]);
    get config(): string | string[];
    private _responsiveContainer;
    ...
    constructor(templateRef: TemplateRef<Object>, _responsiveState: ResponsiveState, viewContainer: ViewContainerRef, cd: ChangeDetectorRef, platformService: PlatformService);
    init_responsive(): void;
    ...
    private updateIEversion;
    private updateSizes;
    private updateEvent;
    private showHideOperations;
    private matchValues;
    ngOnDestroy(): void;
    private _ifValueChanged;
    private isJSON;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ResponsiveDirective, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<ResponsiveDirective, "[responsive]", never, { "responsive": "responsive"; "responsiveContainer": "responsiveContainer"; }, { "changes": "changes"; }, never>;
}
