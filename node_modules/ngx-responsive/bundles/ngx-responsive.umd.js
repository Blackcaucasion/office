(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-responsive', ['exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/common'], factory) :
    (global = global || self, factory(global['ngx-responsive'] = {}, global.ng.core, global.rxjs, global.rxjs.operators, global.ng.common));
    ...
    ***************************************************************************** */
    ...
    var PlatformService = /** @class */ (function () {
        function PlatformService(_platformId, responsiveConfig) {
            this._platformId = _platformId;
            this.responsiveConfig = responsiveConfig;
            this.isServer = common.isPlatformServer(_platformId);
            this.isBrowser = common.isPlatformBrowser(_platformId);
        }
        PlatformService.prototype.isEnabledForPlatform = function () {
        ...
        PlatformService.ctorParameters = function () { return [
            ...
            { type: ResponsiveConfig, decorators: [{ type: core.Inject, args: [ResponsiveConfig,] }] }
        ]; };
        PlatformService = __decorate([
            core.Injectable(),
            __param(0, core.Inject(core.PLATFORM_ID)),
            __param(1, core.Inject(ResponsiveConfig))
        ], PlatformService);
    ...
    var BrowserInfoRx = /** @class */ (function (_super) {
        ...
        function BrowserInfoRx(_responsiveState, platformService) {
    ...
    var OrientationInfo = /** @class */ (function () {
        function OrientationInfo(_responsiveState, platformService) {
            this._responsiveState = _responsiveState;
            this._isEnabledForPlatform = null;
            this.replaySubject$ = new rxjs.ReplaySubject();
            this._isEnabledForPlatform = platformService.isEnabledForPlatform();
    ...
    var OrientationInfoRx = /** @class */ (function (_super) {
        ...
        function OrientationInfoRx(_responsiveState, platformService) {
            var _this = _super.call(this, _responsiveState, platformService) || this;
            _this._responsiveState = _responsiveState;
            return _this;
        }
    ...
    var ResponsiveSizeInfoRx = /** @class */ (function (_super) {
        ...
        function ResponsiveSizeInfoRx(_responsiveState, platformService) {
            var _this = _super.call(this, _responsiveState, platformService) || this;
            _this._responsiveState = _responsiveState;
            return _this;
        }
    ...
    var ResponsiveWindowDirective = /** @class */ (function () {
        function ResponsiveWindowDirective(_responsiveState, el, cd, platformService, _responsiveConfig) {
            ...
            this.currentBreakpoint$ = this._responsiveState
                .ancho$
                .pipe(operators.map(this.getCurrentBreakpoint.bind(this)));
        }
    ...
    exports.ɵb = BrowserInfo;
    exports.ɵc = IeInfo;
    exports.ɵd = DevicesInfo;
    exports.ɵe = DeviceStandardInfo;
    exports.ɵf = OrientationInfo;
