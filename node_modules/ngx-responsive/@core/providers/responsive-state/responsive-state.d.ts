...
export declare class ResponsiveState {
    ...
    private _userAgent;
    private isEnabledForPlatform;
    private _forceRefresh$;
    constructor(platformService: PlatformService, _responsiveConfig: ResponsiveConfig);
    forceRefresh(): void;
    /**
    * @name registerWindow
    * @param rw
    ...
    */
     ...
     */
    isBot(): boolean;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ResponsiveState, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<ResponsiveState>;
}

//# sourceMappingURL=responsive-state.d.ts.map